...
Private Sub V100_CreateNewJobFromLibrary(ByVal jobID As String, ByVal jobName As String, ByVal preparedBy As String)
    ...
    CurrentDb.Execute _
        "INSERT INTO tblJobs (JobID, JobName, PreparedBy, CreatedAt, UpdatedAt) VALUES (" & _
        V100_Q(jobID) & ", " & V100_Q(jobName) & ", " & V100_Q(preparedBy) & ", Now(), Now());", _
        dbFailOnError
